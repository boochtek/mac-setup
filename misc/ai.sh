...
if [[ $(arch) == 'arm64' ]]; then
    ...
    echo -n "$(tput setaf 1)ChatGPT desktop app is only available on Apple Silicon Macs"
    echo "running MacOS Sonoma (14.0) or newer. Skipping installation.$(tput sgr0)"
fi
